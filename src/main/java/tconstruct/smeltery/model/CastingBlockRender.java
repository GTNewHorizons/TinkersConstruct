...
public class CastingBlockRender implements ISimpleBlockRenderingHandler {
    ...
    private static final float[][] TABLE_BOUNDS = {
        { 0.0F, 0.625F, 0.0F, 1.0F, 0.9375F, 1.0F },
        ...
        { 0.0F, 0.0F, 0.0F, 0.3125F, 0.625F, 0.3125F },
        { 0.6875F, 0.0F, 0.0F, 1.0F, 0.625F, 0.25F },
        { 0.0F, 0.0F, 0.6875F, 0.3125F, 0.625F, 1.0F },
        { 0.6875F, 0.0F, 0.6875F, 1.0F, 0.625F, 1.0F } };

    private static final float[][] FAUCET_BOUNDS = {
        { 0.25F, 0.25F, 0.625F, 0.75F, 0.375F, 1.0F },
        { 0.25F, 0.25F, 0.625F, 0.375F, 0.625F, 1.0F },
        { 0.625F, 0.25F, 0.625F, 0.75F, 0.625F, 1.0F } };

    private static final float[][] BASIN_BOUNDS = {
        { 0.125F, 0.125F, 0.125F, 0.875F, 0.25F, 0.875F },
        { 0.0F, 0.0F, 0.0F, 0.3125F, 0.125F, 0.3125F },
        { 0.6875F, 0.0F, 0.0F, 1.0F, 0.125F, 0.3125F },
        { 0.0F, 0.0F, 0.6875F, 0.3125F, 0.125F, 1.0F },
        { 0.6875F, 0.0F, 0.6875F, 1.0F, 0.125F, 1.0F },
        { 0.0F, 0.125F, 0.0F, 0.125F, 1.0F, 1.0F },
        { 0.875F, 0.125F, 0.0F, 1.0F, 1.0F, 1.0F },
        { 0.125F, 0.125F, 0.0F, 0.875F, 1.0F, 0.125F },
        { 0.125F, 0.125F, 0.875F, 0.875F, 1.0F, 1.0F } };
        ...
        if (modelID == searedModel) {
            ...
            if (metadata == 0) {
                ...
                if (world.getTileEntity(x, y, z) instanceof FaucetLogic) {
                    ...
                    if ((uBlock == TinkerSmeltery.searedBlock || uBlock == TinkerSmeltery.searedBlockNether)
                            && uMeta == 0) {
                        yMin = -0.125F;
