...
public class TinkerWeaponry {
    ...
    private void registerMaterials() {
        ...
        TConstructRegistry.addFletchingMaterial(
                ...
                new ItemStack(TinkerWeaponry.fletching, 1, 0),
                95F,
                0.05F,
                1.0f,
                0xffffff); // Feather
        ...
        TConstructRegistry.addFletchingMaterial(
                ...
                new ItemStack(TinkerWeaponry.fletching, 1, 2),
                100F,
                0.005F,
                0.8f,
                0x82c873); // Slime
        TConstructRegistry.addFletchingMaterial(
                ...
                new ItemStack(TinkerWeaponry.fletching, 1, 3),
                100F,
                0.005F,
                0.8f,
                0x74c8c7); // BlueSlime
        TConstructRegistry.addFletchingMaterial(
                4,
                2,
                new ItemStack(TinkerWorld.slimeLeaves, 1, 0),
                new ItemStack(TinkerWeaponry.fletching, 1, 4),
                98F,
                0.02F,
                1.4F,
                0x74e8c7); // Slime leaves
        ...
        TConstructRegistry.addBowstringMaterial(
                ...
                new ItemStack(TinkerWeaponry.bowstring, 1, 0),
                1F,
                1F,
                1f,
                0xeeeeee); // String
    ...
    private void registerBoltCasting() {
        if (PHConstruct.alternativeBoltRecipe) GameRegistry.addRecipe(new AlternateBoltRecipe());
