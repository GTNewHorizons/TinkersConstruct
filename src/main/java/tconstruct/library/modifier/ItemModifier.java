...
public abstract class ItemModifier {
    ...
    protected String getProperName(String tooltip, String tag) {
        ...
        if (tag.equals(tooltip) || tag.equals(tooltip + " I")) return tooltip + " II";

        if (tag.equals(tooltip + " II")) return tooltip + " III";

        if (tag.equals(tooltip + " III")) return tooltip + " IV";

        if (tag.equals(tooltip + " IV")) return tooltip + " V";

        if (tag.equals(tooltip + " V")) return tooltip + " VI";

        if (tag.equals(tooltip + " VI")) return tooltip + " VII";

        if (tag.equals(tooltip + " VII")) return tooltip + " VIII";

        if (tag.equals(tooltip + " VIII")) return tooltip + " IX";
