...
public class TinkerTools {
    ...
    public void preInit(FMLPreInitializationEvent event) {
        ...
        OreDictionary.registerOre("tconstructStencilTable", new ItemStack(TinkerTools.toolStationWood, 1, 12));
        OreDictionary.registerOre("tconstructStencilTable", new ItemStack(TinkerTools.toolStationWood, 1, 13));
    ...
    private void craftingTableRecipes() {
        ...
        GameRegistry.addRecipe(
                new ItemStack(TinkerTools.toolStationWood, 1, 2),
                "p",
                "w",
                'p',
                new ItemStack(TinkerTools.blankPattern, 1, 0),
        ...
        GameRegistry.addRecipe(
                new ItemStack(TinkerTools.toolStationWood, 1, 3),
                "p",
                "w",
                'p',
                new ItemStack(TinkerTools.blankPattern, 1, 0),
        ...
        GameRegistry.addRecipe(
                new ItemStack(TinkerTools.toolStationWood, 1, 4),
                "p",
                "w",
                'p',
                new ItemStack(TinkerTools.blankPattern, 1, 0),
        ...
        GameRegistry.addRecipe(
                new ItemStack(TinkerTools.toolStationWood, 1, 11),
                "p",
                "w",
                'p',
                new ItemStack(TinkerTools.blankPattern, 1, 0),
        ...
        GameRegistry.addRecipe(
                new ItemStack(TinkerTools.toolStationWood, 1, 12),
                "p",
                "w",
                'p',
                new ItemStack(TinkerTools.blankPattern, 1, 0),
        ...
        GameRegistry.addRecipe(
                new ItemStack(TinkerTools.toolStationWood, 1, 13),
                "p",
                "w",
                'p',
                new ItemStack(TinkerTools.blankPattern, 1, 0),
    ...
    private void modIntegration() {
        ...
        if (obj != null) {
            ...
            PatternBuilder.instance.registerFullMaterial(
                    ...
                    2,
                    "Thaumium",
                    new ItemStack(TinkerTools.toolShard, 1, 31),
            ...
            if (TConstruct.pulsar.isPulseLoaded("Tinkers' Weaponry")) {
                ...
                TConstructRegistry.addBowstringMaterial(
                        1,
                        2,
                        new ItemStack((Item) obj, 1, 7),
                        new ItemStack(TinkerWeaponry.bowstring, 1, 1),
                        1F,
                        0.8F,
                        0.9f,
                        0x63bcd9);
